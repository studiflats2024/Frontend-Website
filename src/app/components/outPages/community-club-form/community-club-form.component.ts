...
@Component({
  selector: 'app-community-club-form',
  templateUrl: './community-club-form.component.html',
  styleUrls: ['./community-club-form.component.css']
})
export class CommunityClubFormComponent {
   contactForm: FormGroup;
  loading = false;

  private engazUrl ="https://api.engazcrm.net/api/company3/save/COMMUNITYCLUB1026922bcb58f08c?subdomain=extech" ;
...
get mobileCtrl() { return this.contactForm.get('mobile'); }
