...
@Component({
  selector: 'app-german-coure-form',
  templateUrl: './german-coure-form.component.html',
  styleUrls: ['./german-coure-form.component.css']
})
export class GermanCoureFormComponent {
